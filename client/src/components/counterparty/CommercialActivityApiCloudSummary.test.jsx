...
const makeSource = () => ({ summary: { kadCaseInfoErrorCases: 0 }, analysis: {
  ...
  enforcement: { summary: { activeCount: 4, activeMonetaryCount: 1, activeNonMonetaryCount: 2,
    activeZeroOrUnknownAmountCount: 1, activeAmount: 2210747.3, closedCount: 8, closedAmount: 888888 } },
